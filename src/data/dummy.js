  ...
  return (
    <table className="detailtable" style={{ width: "100%" }}>
      ...
      <tbody>
        <tr>
          <td rowSpan={4} className="images">
            <img
              ...
              src={props?.fileToBase64}
              alt={props.idNumber}
            />
          </td>
          <td>
            <span style={{ fontWeight: 500 }}>ID: </span> {props?.idNumber}
          </td>
          <td>
        ...
        <tr>
          <td>
            <span style={{ fontWeight: 500 }}>Name: </span> {props?.tutorName}
          </td>
          <td>
            <span style={{ fontWeight: 500 }}>Total Forms: </span>
            80
...
export const courseProfileTemplate = (props) => {
    ...
    <table className="detailtable" style={{ width: "100%" }}>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>Name: </span> {props?.courseName}
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>Courses Instructor: </span>{props?.courseInstructor}
          </td>
          <td>
            {props?.evaForm ?
              <Link to={`/evaluationstats/${courseId}`}>
                <button className="text-indigo-600 hover:text-indigo-900 ">
                  <p className="hover:underline hover:underline-offset-2">
                    Check Stats
                  </p>
    ...
    <table className="detailtable" style={{ width: "100%" }}>
      ...
      <tbody>
        <tr>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>Year: </span> {props?.Year}
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>GPA: </span> {props?.GPA}
          </td>
          <td>
            <span style={{ fontWeight: 500 }}>Forms Filled:</span>
            {1}
        ...
        <tr>
          ...
          <td>
            <span style={{ fontWeight: 500 }}>CGPA: </span> {props?.GPA}
          </td>
          <td>
            <span style={{ fontWeight: 500 }}>Forms Remaining:</span>
            {1}
...
export const courseGrid = [
  ...
  {
    headerText: "Instrutor Name",
    field: "coursesInstructor",
    width: "120",
    textAlign: "Center",
  },
  {
